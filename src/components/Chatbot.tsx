...
const MessageBubble = ({ message, language }: { message: ChatMessage; language: LanguageCode }) => (
  <div className={`flex ${message.type === 'user' ? 'justify-end' : 'justify-start'} mb-4`}>
    <div className="flex items-start max-w-[80%]">
      {message.type === 'bot' && (
        <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center mr-2 mt-1">
      ...
      {message.type === 'user' && (
        <div className="w-8 h-8 rounded-full bg-gray-900 flex items-center justify-center ml-2 mt-1">
      ...
      <div className="px-4 pt-2 pb-1 border-t border-gray-100 bg-white">
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="text-sm px-3 py-1.5 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors text-gray-700"
          >
      ...
      <div className="p-4 border-t border-gray-100 bg-white">
        <div className="flex items-end space-x-2">
          <textarea
            ...
            className="flex-1 resize-none border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent max-h-24 text-sm"
            rows={1}
            disabled={isLoading}
          />
          <button
            ...
            className="bg-gray-900 text-white p-3 rounded-xl hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex-shrink-0"
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl h-[90vh] max-h-[800px] flex flex-col shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-2xl font-medium text-gray-900">{t.bookingTitle}</h2>
              </div>
              <button
